            ...
            <form action="logicaCRUD.php?" method="POST" >
                <table class="data-n-proy">
                    <tr>
                        ...
                        <td class="col-n-proy"><input type="text" name="nombre" placeholder="Nombre del proyecto"></td>
                    </tr>
                    <tr>
                        <td class="col-n-proy">Comitente</td>
                        <td class="col-n-proy"><input type="text" name="comitente" placeholder="Nombre del comitente"></td>
                    </tr>
                    <tr>
                        <td class="col-n-proy">Fecha de Entrega</td>
                        <td class="col-n-proy"><input type="date" name="fecha_entrega"></td>
                    </tr>
                    <tr>
                        <td class="col-n-proy">Carga Horaria</td>
                        <td class="col-n-proy"><input type="text" name="carga_horaria" placeholder="Hrs totales"></td>
                    </tr>
                    <tr>
                        <td class="col-n-proy">Valor Hora</td>
                        <td class="col-n-proy"><input type="text" name="valor_hora" placeholder="$200,00"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="col-n-proy"><input type="text" name="valor_proyecto" placeholder="Nuevo valor"></td>
                    </tr>
                    <tr>
                        <td class="col-n-proy">Cargar Imagen</td>
                        <td class="col-n-proy"><input type="text" name="url_imagen" placeholder="Url imagen"></td>
                    </tr>
                    <tr>
                        <td class="col-n-proy">Descripción</td>
                        <td class="col-n-proy"><textarea name="descripcion"placeholder="Breve descripción del proyecto"></textarea></td>
                    </tr>
                </table>
