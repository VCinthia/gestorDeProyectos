                ...
                <form action="editar-proyecto.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    <table class="data-n-proy">
                        ...
                        <tr>
                            ...
                            <td class="col-n-proy"><input type="text" name="carga_horaria"
                                    placeholder="<?php echo $carga_horaria; ?>" value="<?php echo $carga_horaria; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="col-n-proy">Valor Hora</td>
                            <td class="col-n-proy"><input type="text" name="valor_hora" placeholder="$200,00"
                                    value="<?php echo $valor_hora; ?>"></td>
                        </tr>
                        <tr>
                            <td class="col-n-proy">Valor Estimativo</td>
                            <td class="col-n-proy"><input type="text" name="valor_estimativo"
                                    value="<?php echo $valor_estimativo; ?>" placeholder="Carga horaria x Valor hora">
                            </td>
                        </tr>
                        <tr>
                            <td class="col-n-proy">Valor Proyecto</td>
                            <td class="col-n-proy"><input type="text" name="valor_proyecto"
                                    value="<?php echo $valor_proyecto; ?>" placeholder="Nuevo valor"></td>
                        </tr>
                        <tr>
